...
public class PostAdapterInProfile extends RecyclerView.Adapter<PostAdapterInProfile.PostViewHolderInProfile> {
    ...
    public PostAdapterInProfile(Context context, List<Post> postList) {
    ...
    @NonNull
    @Override
    public PostViewHolderInProfile onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.post_item_in_profile, parent, false);
        return new PostViewHolderInProfile(view);
    }

    @SuppressLint("RecyclerView")
    @Override
    public void onBindViewHolder(@NonNull PostViewHolderInProfile holder, int position) {
    ...
    public class PostViewHolderInProfile extends RecyclerView.ViewHolder{
        ...
        public PostViewHolderInProfile(@NonNull View itemView) {
            super(itemView);
